...
#'
#' @param x An \code{\link{hdpSampleChain}} or \code{\link{hdpSampleMulti}} object
#'
...
#' \item{multi.chains}{An \code{\link{hdpSampleChain}}
#'    or \code{\link{hdpSampleMulti}}
...
extract_sigs_from_clusters <-  function(x,
  ...
  clusters <- cutree::cutree(cosine.dist.hctree,  h=hc.cutoff)
